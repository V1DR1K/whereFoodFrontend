...
export function ItemCard({ item, username, onEditItem, onEditReview }: { item: Item; username?: string; onEditItem: (item: Item) => void; onEditReview: (item: Item) => void }) {
  ...
  const ownsItem = item.createdBy === username;
