...
export function DashboardPage() {
  return <section className="picks-dashboard">
    ...
    <div className="module-picker">
      ...
      <Link to="/why-fun" className="module-card module-card--fun"><div className="module-card__emoji">🎲<span>🕹️</span></div><p>QUÉ HACEMOS</p><h2>why<span>fun</span></h2><small>Guarden salidas, juegos y experiencias</small><b>Entrar a divertirse →</b></Link>
    </div>
